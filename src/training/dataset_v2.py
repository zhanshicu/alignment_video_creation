    ...
    def __getitem__(self, idx: int) -> Dict:
        ...
        if not os.path.exists(screenshot_path):
            ...
            if idx == 0:  # Only warn once
                print(f"\n⚠️  WARNING: Screenshots not found at {self.screenshots_dir}")
                print(f"   Creating dummy black images for testing.")
                print(f"   To use real data, ensure screenshots exist at the path above.\n")
        ...
        if not os.path.exists(mask_path):
            ...
            if idx == 0:  # Only warn once
                print(f"\n⚠️  WARNING: Keyword masks not found at {self.keyword_masks_dir}")
                print(f"   Creating dummy masks for testing.")
                print(f"   To generate real masks, run: python scripts/generate_keyword_masks.py\n")
